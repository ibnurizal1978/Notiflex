...
//button
$btn_save       = '<input type="submit" class="btn btn-primary ms-auto" value="Save" onclick="return confirm(\'Are you sure? Click cancel if you are not sure\');" />';
$btn_save2      = '<button type="submit" class="btn btn-primary ms-auto" id="submit_data">Simpan</button>';
$btn_save2_loading = '<button type="submit" class="btn btn-primary ms-auto" id="submit_data" disabled>Memproses...</button>';
#$btn_cancel    = '<button type="button" class="btn btn-smoke btn-pill" data-dismiss="modal">Cancels</button>';
$btn_cancel     = '<a href="#" class="btn btn-link link-secondary" data-bs-dismiss="modal">Cancel</a>';
...
//notification for save or edit data
$notif_data_empty       = 'Please fill type column with red asterisk mark';
$notif_data_duplicate   = 'This name is already in your database';
$notif_data_success     = 'Your data has been successfully added or updated';
$notif_product_minimum_order = 'Minimum order produk ini kurang';
$notif_is_numeric = 'This data must be a numeric';
